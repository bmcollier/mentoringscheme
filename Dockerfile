...
COPY scripts/person.cob /usr/local/apache2/cgi-bin/

RUN cobc -x -free /usr/local/apache2/cgi-bin/api.cob /usr/local/apache2/cgi-bin/root.cob /usr/local/apache2/cgi-bin/towns.cob /usr/local/apache2/cgi-bin/person.cob -o /usr/local/apache2/cgi-bin/api
